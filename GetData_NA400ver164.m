...
Header_Output  = Header_decimal(1,1) + Header_decimal(2,1) + Header_decimal(3,1) + Header_decimal(4,1)...
                 + Header_decimal(5,1) + Header_decimal(6,1) + Header_decimal(7,1) + Header_decimal(8,1);
...
% 1. add last data
BufferL(Buffer_FreshRate+1:Buffer_FreshRate+sample_Num,:) = new_EEGData(:,channelLeft);
BufferR(Buffer_FreshRate+1:Buffer_FreshRate+sample_Num,:) = new_EEGData(:,channelRight);
% 2. shift forward & delete old data
BufferL(1:Buffer_FreshRate,:)                             = BufferL(1+sample_Num:(Buffer_FreshRate+sample_Num),:);
BufferR(1:Buffer_FreshRate,:)                             = BufferR(1+sample_Num:(Buffer_FreshRate+sample_Num),:);